      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1100, margin: "0 auto", padding: "3rem 2rem 6rem" }}>
            ...
            <div style={{ padding: "2.5rem 3rem" }}>
              ...
              <div style={{ display: "flex", gap: "1rem" }}>
                <input
                  ...
                  placeholder={hitLimit ? "Come back tomorrow or upgrade for unlimited questions..." : `Ask ${c.name} anything...`}
                  disabled={hitLimit}
        ...
        {showUpgrade && !isPro && (
          <div style={{ border: "2px solid #3a2800", borderRadius: 16, padding: "3rem", background: "#0c0800", animation: "fadeIn 0.3s ease", textAlign: "center", marginBottom: "2rem" }}>
            <div style={{ fontSize: "0.8rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#886600", marginBottom: "1rem" }}>You've reached today's limit</div>
            <p style={{ margin: "0 0 2rem", fontSize: "1.2rem", color: "#aa9966", fontStyle: "italic", lineHeight: 1.8 }}>
              You've used your {FREE_LIMIT} free questions for today. Come back tomorrow — or upgrade to unlock unlimited questions and {cryptids.filter(cr => !cr.free).length} more cryptids, including the Fresno Nightcrawler, who is just out for a walk and has a lot of feelings about it.
            </p>
